...
namespace Albatross.DevTools.AzureDevOps {
	[Verb("azure-devops cleanup-package-versions", typeof(CleanUpPackageVersions), Description = "Delete package versions in the specified Azure DevOps feed based on a version range and optional package pattern.")]
